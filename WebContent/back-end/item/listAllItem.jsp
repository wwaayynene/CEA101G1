...
<body bgcolor='white'>
	...
	<div id="title">
		...
		<div>
			<a href="<%=request.getContextPath()%>/back-end/item/addItem.jsp"
				class="home">新增商品</a>
		</div>
	...
	<table id="myTable">
		...
		<c:forEach var="itemVO" items="${list}">
			...
			<tr>
				...
				<td><a
					href="<%=request.getContextPath()%>/back-end/item_pics/listAllByItem_no.jsp?item_no=${itemVO.item_no}">詳細照片</a></td>
				<td>${itemVO.points}</td>
				<td>
					<FORM METHOD="post"
