...
<%@ include file="/back-end/backend_header.file"%>
...
<body>
	...
	<div class="page">
		...
		<ul>
			<li><a href='<%=request.getContextPath()%>/back-end/item/listAllItem.jsp'>所有商品查詢</a> <br>
			<br></li>
			<li>
				<FORM METHOD="post"
	...
	<jsp:useBean id="itemSvc" scope="page" class="com.item.model.ItemService" />
		...
		<ul>
			<li><a
				href='<%=request.getContextPath()%>/back-end/item/addItem.jsp'>新增商品</a></li>
			<li><a
				href='<%=request.getContextPath()%>/back-end/item/listAllItem.jsp'>修改商品</a></li>
			<li><a
				href='<%=request.getContextPath()%>/back-end/item_type/addItem_type.jsp'>新增商品類別</a></li>
			<li><a
				href='<%=request.getContextPath()%>/back-end/item_type/listAllItem_type.jsp'>修改商品類別</a></li>
		</ul>
	</div>
	<%@ include file="/back-end/backend_footer.file"%>
