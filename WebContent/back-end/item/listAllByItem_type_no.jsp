...
<body bgcolor='white'>
	...
	<div id="title">
		...
		<div>
			<a href="<%=request.getContextPath()%>/back-end/item/select_item.jsp" class="home">回商品管理</a>
		</div>
...
<table>
	...
	<c:forEach var="itemVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td><a href="<%=request.getContextPath()%>/back-end/item_pics/listAllByItem_no.jsp?item_no=${itemVO.item_no}">詳細照片</a></td> 
			<td>${itemVO.points}</td>
			<td> 
