...
<%@ include file="/back-end/backend_sidebar.file" %>
	<div id="title">
		...
		<div>
			<a
				href="<%=request.getContextPath()%>/back-end/shop_order/select_shop_order.jsp"
		...
		<c:forEach var="shop_orderVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tr>
				...
				<td><fmt:formatDate value="${shop_orderVO.sp_dlvr}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
				<td><a
					href="<%=request.getContextPath()%>/back-end/shop_order_detail/listAllDetail.jsp?sp_odno=${shop_orderVO.sp_odno}">訂單細項</a></td>
