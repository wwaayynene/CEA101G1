	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/back-end/item/select_item.jsp");
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/back-end/item_pics/listAllByItem_no.jsp");
					failureView.forward(req, res);
					return;//程式中斷
				}
				...
				String url = "/back-end/item_pics/listAllByItem_no.jsp";
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				/***************************3.查詢完成,準備轉交(Send the Success view)************/
				req.setAttribute("item_picsVO", item_picsVO);         // 資料庫取出的empVO物件,存入req
				String url = "/back-end/item_pics/update_item_pic_input.jsp";
...
//				}
				...
				String url = "/back-end/item_pics/listAllByItem_no.jsp?=" + item_no;
		...
		if ("delete".equals(action)) { // 來自listAllEmp.jsp
			...
			try {
				...
				String url = "/back-end/item_pics/listAllByItem_no.jsp?item_no="+item_no;
