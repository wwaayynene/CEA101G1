	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				String url = "/back-end/shop_order_detail/update_shop_order_detail_input.jsp";
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/back-end/shop_order_detail/listAllDetail.jsp");
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req.getRequestDispatcher("/back-end/shop_order_detail/update_shop_order_detail_input.jsp");
					failureView.forward(req, res);
					return; // 程式中斷
				}
				...
				String url = "/back-end/shop_order_detail/listAllDetail.jsp";
